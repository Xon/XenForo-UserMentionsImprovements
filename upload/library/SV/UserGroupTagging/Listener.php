...
class SV_UserGroupTagging_Listener
{
    ...
    public static function install($installedAddon, array $addonData, SimpleXMLElement $xml)
    {
        ...
        SV_UserGroupTagging_Install::addColumn('xf_user_group', 'sv_taggable', 'tinyint(3) NOT NULL default 0');
        SV_UserGroupTagging_Install::addColumn('xf_user_group', 'sv_private', 'tinyint(3) NOT NULL default 0');
        ...
        SV_UserGroupTagging_Install::addColumn('xf_user_option', 'sv_email_on_tag', 'tinyint(3) NOT NULL default 0');
    ...
    public static function uninstall()
    {
        ...
        SV_UserGroupTagging_Install::dropColumn('xf_user_option', 'sv_email_on_tag');
